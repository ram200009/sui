...
impl<'a> SignatureAggregator<'a> {
    ...
    pub fn new(transaction: VerifiedTransaction, committee: &'a Committee) -> Self {
        Self::new_unsafe(transaction.into_inner(), committee)
    }
    ...
    pub fn new_unsafe(transaction: Transaction, committee: &'a Committee) -> Self {
        Self {
            ...
            partial: CertifiedTransaction::new(
                committee.epoch,
...
impl CertifiedTransaction {
    pub fn new(epoch: EpochId, transaction: VerifiedTransaction) -> CertifiedTransaction {
        let transaction = transaction.into_inner();
